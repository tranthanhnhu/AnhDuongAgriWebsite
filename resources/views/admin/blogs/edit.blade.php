...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div>
        <a href="{{ route('admin.blogs.show', $blog) }}" class="btn btn-info me-2">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('fb_link') is-invalid @enderror" id="fb_link" name="fb_link" value="{{ old('fb_link', $blog->fb_link) }}" placeholder="https://facebook.com/...">
                        @error('fb_link')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                            ...
                            <option value="published" {{ old('status', $blog->status) == 'published' ? 'selected' : '' }}>Đã xuất bản</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
